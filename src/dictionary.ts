...
export const DICTIONARY: Entry[] = [
  ...
  { command: "\\lim", name: "limit", tags: ["calculus", "analysis", "topology", "operator"], symbol: "lim", keywords: ["converge", "tends to"] },
  ...
  { command: "\\sqrt{}", name: "square root", tags: ["structure"], symbol: "√", keywords: ["radical", "root"] },
  { command: "\\begin{pmatrix} \\end{pmatrix}", name: "matrix (parentheses)", tags: ["linear algebra", "structure"], symbol: "⎡⎤", example: "\\begin{pmatrix} a & b \\\\ c & d \\end{pmatrix}", snippet: "\\begin{pmatrix} #1 & #2 \\\\ #3 & #4 \\end{pmatrix}", keywords: ["pmatrix"] },
  ...
  // ── Structures ───────────────────────────────────────────────────────
  { command: "\\binom{}{}", name: "binomial coefficient", tags: ["combinatorics", "structure"], snippet: "\\binom{#{1:n}}{#{2:k}}", keywords: ["choose", "combination", "n choose k"] },
  { command: "\\begin{bmatrix} \\end{bmatrix}", name: "matrix (brackets)", tags: ["linear algebra", "structure"], symbol: "⎡⎤", example: "\\begin{bmatrix} a & b \\\\ c & d \\end{bmatrix}", snippet: "\\begin{bmatrix} #1 & #2 \\\\ #3 & #4 \\end{bmatrix}", keywords: ["bmatrix"] },
  { command: "\\begin{cases} \\end{cases}", name: "cases / piecewise", tags: ["structure", "analysis"], symbol: "{", example: "f(x)=\\begin{cases} a & x>0 \\\\ b & x\\le 0 \\end{cases}", snippet: "\\begin{cases} #1 & #{2:x > 0} \\\\ #3 & #{4:otherwise} \\end{cases}", keywords: ["piecewise", "case distinction"] },
  ...
  // ── Accents ──────────────────────────────────────────────────────────
  { command: "\\hat{}", name: "hat", tags: ["accent", "structure"], keywords: ["unit vector", "estimator", "fourier transform"] },
  { command: "\\vec{}", name: "vector", tags: ["accent", "structure"], keywords: ["arrow", "vector"] },
  ...
  { command: "\\tilde{}", name: "tilde", tags: ["accent", "structure"], keywords: ["twiddle", "covering space"] },
